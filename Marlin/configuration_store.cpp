 ...
 *
 * ULTIPANEL:                                       9 bytes
 *  396  M145 S0 H lcd_preheat_hotend_temp          (int x3)
 *  400  M145 S0 B lcd_preheat_bed_temp             (int x3)
 *  404  M145 S0 F lcd_preheat_fan_speed            (int x3)
 *
 * PIDTEMP:                                         66 bytes
 ...
 *
 * PIDTEMPBED:                                      12 bytes
 *  496  M304 PID  thermalManager.bedKp, .bedKi, .bedKd (float x3)
 *
 * DOGLCD:                                          2 bytes
 ...
 *  541  M200 D    volumetric_enabled               (bool)
 *  542  M200 T D  filament_size                    (float x5) (T0..3)
 *
 ...
 *  584  M906 E4   Stepper E4 current               (uint16_t)
 *
 * LIN_ADVANCE:                                     8 bytes
 *  588  M900 K    extruder_advance_k               (float)
 *  592  M900 WHD  advance_ed_ratio                 (float)
 *
 * HAS_MOTOR_CURRENT_PWM:
 *  596  M907 X    Stepper XY current               (uint32_t)
 *  600  M907 Z    Stepper Z current                (uint32_t)
 *  604  M907 E    Stepper E current                (uint32_t)
 *
 *  608                                Minimum end-point
 * 1925 (608 + 36 + 9 + 288 + 984)     Maximum end-point
 *
 * ========================================================================
